...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/tools/eval-cases", label: "Eval Cases", icon: TestTubes, desc: "Spec → coverage-gated eval cases." },
  { href: "/tools/api-contract", label: "API Contract", icon: Webhook, desc: "Prose → validated OpenAPI 3.1." },
  { href: "/tools/complexity", label: "Complexity", icon: Gauge, desc: "Big-O with an audited derivation." },
